...
public class TlsECDHEKeyExchange
    ...
    private static int checkKeyExchange(int keyExchange) {
        switch (keyExchange) {
            ...
            case KeyExchangeAlgorithm.ECDHE_RSA:
                /*
                 * GB/T 38636-2020 (TLCP) - SM2 uses ECDHE-style handshake
                 */
    ...
    public short[] getClientCertificateTypes() {
         ...
         * usable with
         * ECDH_ECDSA and ECDH_RSA. Their use with ECDHE_ECDSA and ECDHE_RSA is
         * prohibited because
         * the use of a long-term ECDH client key would jeopardize the forward secrecy
         * property of
         * these algorithms.
         */
